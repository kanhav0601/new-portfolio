...
const ProjectCard = ({ title, description, imgUrl, previewUrl }) => {
    return (
        <div className="relative bg-black p-4 rounded-lg shadow-lg hover:shadow-[0_4px_15px_rgba(255,255,255,0.75)] w-full max-w-sm mx-auto overflow-hidden transition-all duration-300 transform hover:scale-105 hover:bg-black">
